...
class ComputeNode:
    ...
    def __init__(self):  # name is unique per pipe
        ...
        self.mem: SharedMemoryBuffer = None
        ...
        self.node_client = NodeClient(NODE_MANAGER_PROC_NAME, self.on_ws_message,
                                      server_base_url=self.server_base_url())

    def get_proc_queues(self, proc_name: str) -> API_Proc_Queues:
        queues = API_Proc_Queues(proc_name=proc_name)
    ...
    def is_node_memory_allocated():
        try:
            SharedMemoryBuffer(node_shared_mem_name, node_shared_mem_size,
    ...
    def register_pipe(self, pipe: API_Pipe):
